import{I as q,J as g,L as A,O as P,k as Q,m as E,o as N,r as O}from"./chunk-G4GGURKU.js";import{Hb as l,Ib as D,Jb as F,Kb as f,Ma as o,Mb as m,Nb as y,Q as v,R as h,Rb as j,Sb as S,W as T,Ya as b,Yb as z,Za as C,ab as $,cb as r,da as p,lb as i,ob as k,pb as I,uc as B,vb as u,wb as d,xb as x,yb as M,zb as w}from"./chunk-HE3ZW6WA.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
