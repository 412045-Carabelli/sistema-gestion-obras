...
public class ReportesBffController {
    ...
    // Filtros en cascada para cuentas corrientes
    @GetMapping("/filtros/obras-por-proveedor")
    public Mono<ResponseEntity<List<Map<String, Object>>>> obrasPorProveedor(
        ...
        return webClientBuilder.build()
                .get()
                .uri(obrasServiceUrl + "/proveedores/" + proveedorId + "/obras")
                .accept(MediaType.APPLICATION_JSON)
                .retrieve()
    ...
    public Mono<ResponseEntity<List<Map<String, Object>>>> clientesPorProveedor(
            @RequestParam(required = false) Long proveedorId) {
        if (proveedorId == null) {
            return Mono.just(ResponseEntity.ok(List.of()));
        }
        return webClientBuilder.build()
                .get()
                .uri(obrasServiceUrl + "/proveedores/" + proveedorId + "/clientes")
                .accept(MediaType.APPLICATION_JSON)
                .retrieve()
                .bodyToMono(new ParameterizedTypeReference<List<Map<String, Object>>>() {})
                .map(ResponseEntity::ok)
    ...
    public Mono<ResponseEntity<List<Map<String, Object>>>> obrasPorCliente(
        ...
        return webClientBuilder.build()
                .get()
                .uri(obrasServiceUrl + "/clientes/" + clienteId + "/obras")
                .accept(MediaType.APPLICATION_JSON)
                .retrieve()
                .bodyToMono(new ParameterizedTypeReference<List<Map<String, Object>>>() {})
                .map(ResponseEntity::ok)
    ...
    public Mono<ResponseEntity<List<Map<String, Object>>>> proveedoresPorObra(
        ...
        return webClientBuilder.build()
                .get()
                .uri(obrasServiceUrl + "/obras/" + obraId + "/proveedores")
                .accept(MediaType.APPLICATION_JSON)
                .retrieve()
                .bodyToMono(new ParameterizedTypeReference<List<Map<String, Object>>>() {})
                .map(ResponseEntity::ok)
