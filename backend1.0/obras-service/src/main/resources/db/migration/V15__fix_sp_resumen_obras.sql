-- V15__fix_sp_resumen_obras.sql
-- Versión simplificada que usa JOINs directos sin subqueries

DROP PROCEDURE IF EXISTS sp_resumen_obras_clientes;
DROP PROCEDURE IF EXISTS sp_resumen_obras_proveedores;
