-- SP para calcular saldos de clientes en bulk (1 query en lugar de 2M llamadas HTTP)
-- Devuelve: id, nombre, total_presupuesto, total_cobros, saldo_pendiente
-- Optimizado: JOIN directo en la BD, agrupa por cliente
-- Ubicación: obras-service (donde están las tablas necesarias)
