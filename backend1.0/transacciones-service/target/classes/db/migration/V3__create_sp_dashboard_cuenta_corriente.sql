-- V3__create_sp_dashboard_cuenta_corriente.sql
-- SP para dashboard: calcula KPIs de cuenta corriente con filtros opcionales
-- Parámetros: @obraId, @clienteId, @proveedorId, @fechaInicio, @fechaFin
-- Devuelve: cobrado, por_cobrar, pagado, por_pagar, resultado
-- Estados válidos: ADJUDICADA, EN_PROGRESO, COBRADA, FACTURADA, FACTURADA_PARCIAL, FINALIZADA
