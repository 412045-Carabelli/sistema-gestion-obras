-- V39__create_sp_facturacion_periodo.sql
-- SP para el reporte de facturacion por periodo: facturado vs por facturar, por obra.
-- Sigue el patron de schemas parametrizados de V32 (SQL dinamico, nombre de BD
-- de obras inyectado como parametro segun el profile activo).
...
BEGIN
  ...
  EXEC sp_executesql @sql,
    N'@obraId BIGINT, @clienteId BIGINT, @fechaInicio DATE, @fechaFin DATE, @organizacion_id BIGINT',
