-- V35__excluir_cotizada_de_cuentas_corrientes.sql
-- Una obra COTIZADA es una cotizacion enviada pero no confirmada por el
-- cliente: no debe generar saldo ni aparecer en ninguna cuenta corriente
-- (ni de cliente ni de proveedor), ni en los filtros en cascada. V31 la
-- habia incluido por error junto con ADJUDICADA/EN_PROGRESO/FINALIZADA.
-- Se recrean los mismos SPs (ultima version vigente: V32 + V33 para
-- sp_deudas_proveedores_con_grupo) quitando COTIZADA de la lista.
