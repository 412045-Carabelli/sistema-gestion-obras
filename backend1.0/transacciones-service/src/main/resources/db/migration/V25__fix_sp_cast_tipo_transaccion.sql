-- V25__fix_sp_cast_tipo_transaccion.sql
-- Fix: CAST(id_tipo_transaccion AS BIGINT) falla con NULL o valores no numéricos.
-- Solución: reemplazar CAST por TRY_CAST que retorna NULL en caso de fallo.
