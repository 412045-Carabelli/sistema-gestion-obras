-- V16__fix_sp_monto_real_cero.sql
-- Corrige sp_deudas_proveedores_con_grupo para aceptar monto_real = 0 como valor válido
-- El problema: monto_real > 0 excluía 0; la solución: usar IS NOT NULL (sin > 0)
...
BEGIN
  ...
  -- Prioriza monto_real si existe (incluye 0), sino usa subtotal
