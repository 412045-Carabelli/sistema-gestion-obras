import{j as q,k as g,m as A,p as P}from"./chunk-XBZW56GN.js";import{k as Q,m as E,o as N,s as O}from"./chunk-RJQHKRPV.js";import{Gb as l,Hb as D,Ib as F,Jb as f,Ka as o,Lb as m,Mb as y,N as v,O as h,Qb as j,Rb as S,T,Wa as b,Xa as C,Yb as z,_a as $,aa as p,ab as r,lb as i,ob as k,pb as I,ub as u,uc as B,vb as d,wb as x,xb as M,yb as w}from"./chunk-PRXPO7JR.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
