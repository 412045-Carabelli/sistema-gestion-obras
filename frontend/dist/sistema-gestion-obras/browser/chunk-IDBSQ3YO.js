import{j as q,k as g,m as A,p as P}from"./chunk-NGSTVZZQ.js";import{k as Q,m as E,o as N,s as O}from"./chunk-QY2RSE5A.js";import{$a as $,Hb as l,Ib as D,Jb as F,Kb as f,La as o,Mb as m,Nb as y,O as v,P as h,Rb as j,Sb as S,U as T,Xa as b,Ya as C,Zb as z,ba as p,bb as r,mb as i,pb as k,qb as I,vb as u,wb as d,wc as B,xb as x,yb as M,zb as w}from"./chunk-ZQ6XIEXU.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
